...
SurfelFusion::SurfelFusion(std::shared_ptr<SurfelIndexMap> surfelIndexMap):_surfelIndexMap(surfelIndexMap) {
}
...
void SurfelFusion::finish(SurfelFusionConfiguration surfelFusionConfiguration, Surfels& surfels, SparseSurfelLandmarksIndex& surfelLandmarksIndex, std::vector<int>& deletedSurfelIndicesList) {
